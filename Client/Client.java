...
public class Client extends WindowAdapter implements ActionListener {
    ...
    public void setView() {
        ...
        mainFrame.setBounds((int) toolkit.getScreenSize().getWidth() / 8, (int) toolkit.getScreenSize().getHeight() / 8,
                (int) toolkit.getScreenSize().getWidth() * 7 / 10, (int) toolkit.getScreenSize().getHeight() * 7 / 10);
